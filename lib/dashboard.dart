        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            DropdownButton<BluetoothDevice>(
              ...
              dropdownColor: const Color(0xFF4DB6AC),
            ),
            ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ControllerButton(
                      ...
                      onPressed: () => _sendMessageToBluetooth("L"),
                    ),
                    ControllerButton(
                      child: const Icon(Icons.keyboard_arrow_right,
                          size: 20, color: Colors.teal),
                      onPressed: () => _sendMessageToBluetooth("R"),
                    ),
                    ControllerButton(
                      child: const Icon(Icons.keyboard_arrow_up,
                          size: 20, color: Colors.teal),
                      onPressed: () => _sendMessageToBluetooth("F"),
                    ),
                    ControllerButton(
                      child: const Icon(Icons.keyboard_arrow_down,
                          size: 20, color: Colors.teal),
                      onPressed: () => _sendMessageToBluetooth("B"),
                    ),
                    ControllerButton(
